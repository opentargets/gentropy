...
from gentropy.decode_ingestion import deCODEManifestGenerationStep


@pytest.fixture
def manifest_df(session: Session) -> DataFrame:
    ...
    data = [
        Row(
            ...
            hasSumstats=True,
            summarystatsLocation="s3a://some_bucket/final_somascan_raw/Proteomics_PC0_10006_7_RAF1_c_Raf_05314415.txt.gz",
            size="925.8 MiB",
        ...
        Row(
            ...
            hasSumstats=True,
            summarystatsLocation="s3a://some_bucket/final_somascan_raw/Proteomics_PC0_10003_15_ZNF41_ZNF41_05242112.txt.gz",
            size="926.9 MiB",
...
class TestdeCODEManifestGenerationStep:
    ...
    def test_decode_manifest_generation_step(
        ...
        manifest_instance.df = manifest_df
...
# class TestdeCODEStudyIndexGenerationStep:
#     """Test deCODEStudyIndexGenerationStep."""

#     @pytest.mark.skip(reason="Not implemented yet")
#     def test_decode_study_index_generation_step(self):
#         """Test deCODEStudyIndexGenerationStep."""
#         pass
