...
sl = ss.window_based_clumping(
    distance=WINDOW_SIZE, collect_locus=True, collect_locus_distance=WINDOW_SIZE
)

sl.df.write.parquet(
    path="gs://ot-team/dochoa/study_locus_collect_21_02_2024.parquet", mode="overwrite"
)
