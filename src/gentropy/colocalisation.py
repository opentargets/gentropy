...
class ColocalisationDefaults(BaseModel, frozen=True):
    ...
    colocalisation_method: Annotated[str, Field(description="Colocalisation method.")]
    restrict_right_studies: Annotated[list[str] | None, Field(description="Restrict right side studies.")] = None
    gwas_v_qtl_overlap_only: Annotated[bool, Field(description="Only GWAS vs molQTL overlaps.")] = False
    colocalisation_method_params: Annotated[dict[str, Any] | None, Field(description="Method parameters.")] = None
