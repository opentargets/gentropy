...
class Session:
    ...
    def _setup_s3_connector(
        ...
        if s3_configuration is not None and not isinstance(
            s3_configuration, (dict, str)
        ):
    ...
    def _setup_gcs_connector(
        ...
        if gcs_configuration is not None and not isinstance(
            gcs_configuration, (dict, str)
        ):
