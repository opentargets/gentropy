...
def _extract_credible_sets(
    ...
    The function assumes that the input df has the following schema:
    ...
    Args:
        associations: DataFrame with study/locus associations.

    Returns:
        DataFrame with lead/tag variant IDs, study ID and logABF.
    """
    return (
        associations.withColumn("credibleSet", f.explode("credibleSets"))
