...
class SessionConfig:
    ...
    _target_: str = "oxygen.common.session.Session"
...
class ColocalisationConfig(StepConfig):
    ...
    priorc2: float = 1e-4
    priorc12: float = 1e-5
    _target_: str = "oxygen.colocalisation.ColocalisationStep"
...
class GeneIndexConfig(StepConfig):
    ...
    _target_: str = "oxygen.gene_index.GeneIndexStep"
...
class GWASCatalogStudyCurationConfig(StepConfig):
    ...
    _target_: str = "oxygen.gwas_catalog_study_curation.GWASCatalogStudyCurationStep"
...
class GWASCatalogStudyInclusionConfig(StepConfig):
    ...
    _target_: str = "oxygen.gwas_catalog_study_inclusion.GWASCatalogStudyInclusionStep"
...
class GWASCatalogIngestionConfig(StepConfig):
    ...
    _target_: str = "oxygen.gwas_catalog_ingestion.GWASCatalogIngestionStep"
...
class EqtlCatalogueConfig(StepConfig):
    ...
    _target_: str = "oxygen.eqtl_catalogue.EqtlCatalogueStep"
...
class FinngenStudiesConfig(StepConfig):
    ...
    _target_: str = "oxygen.finngen_studies.FinnGenStudiesStep"
...
class FinngenSumstatPreprocessConfig(StepConfig):
    ...
    raw_sumstats_path: str = MISSING
    out_sumstats_path: str = MISSING
    _target_: str = "oxygen.finngen_sumstat_preprocess.FinnGenSumstatPreprocessStep"
...
class LDIndexConfig(StepConfig):
    ...
    _target_: str = "oxygen.ld_index.LDIndexStep"
...
class LDBasedClumpingConfig(StepConfig):
    ...
    _target_: str = "oxygen.ld_based_clumping.LDBasedClumpingStep"
...
class LocusToGeneConfig(StepConfig):
    ...
    _target_: str = "oxygen.l2g.LocusToGeneStep"
...
class PICSConfig(StepConfig):
    ...
    _target_: str = "oxygen.pics.PICSStep"
...
class VariantAnnotationConfig(StepConfig):
    ...
    variant_annotation_path: str = MISSING
    _target_: str = "oxygentropy.variant_annotation.VariantAnnotationStep"
...
class VariantIndexConfig(StepConfig):
    ...
    _target_: str = "oxygen.variant_index.VariantIndexStep"
...
class V2GConfig(StepConfig):
    ...
    _target_: str = "oxygen.v2g.V2GStep"
...
class WindowBasedClumpingStep(StepConfig):
    ...
    _target_: str = "oxygen.clump.WindowBasedClumpingStep"
